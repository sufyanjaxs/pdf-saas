...
export const toolDefinitions: ToolDefinition[] = [
  ...
  def(
    ...
    'Rotate',
    'Image',
    'Rotate images by any angle with a live preview of the result.',
    'rotate-ccw',
    ['rotate image', 'turn image', 'image rotation', 'rotate photo'],
  ),
  def(
    'image-flip',
    'Flip Image',
    'Flip',
    'Image',
    'Mirror images horizontally or vertically with instant preview.',
    'flip',
    ['flip image', 'mirror image', 'horizontal flip', 'vertical flip'],
  ),
  def(
    'image-grayscale',
    'Grayscale Image',
    'Grayscale',
    'Image',
    'Convert images to black and white grayscale with adjustable intensity.',
    'droplets',
    ['grayscale image', 'black and white', 'desaturate image', 'monochrome'],
  ),
  def(
    'image-brightness',
    'Brightness & Contrast',
    'B & C',
    'Image',
    'Adjust image brightness, contrast and saturation with live preview.',
    'sun',
    ['brightness', 'contrast', 'saturation', 'image adjustment', 'image brightness'],
  ),
  def(
    'image-blur',
    'Blur Image',
    ...
    'sparkles',
    ['blur image', 'gaussian blur', 'soften image', 'image blur'],
  ),
  def(
    'image-sharpen',
    'Sharpen Image',
    'Sharpen',
    'Image',
    'Enhance image sharpness and edge detail.',
    'paintbrush',
    ['sharpen image', 'image sharpening', 'enhance detail', 'unsharp mask'],
  ),
]
